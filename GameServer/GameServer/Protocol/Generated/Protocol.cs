...
namespace Google.Protobuf.Protocol {
    ...
    static ProtocolReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "bmZvEhYKDnBsYXllck9iZWpjdElkGAIgASgFIjEKCVNfSXRlbUdldBIkCghp",
            ...
            "BEJvbWIQAxIICgRJVEVNEARCG6oCGEdvb2dsZS5Qcm90b2J1Zi5Qcm90b2Nv",
            "bGIGcHJvdG8z"));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          ...
          new pbr::GeneratedClrTypeInfo(new[] {typeof(global::Google.Protobuf.Protocol.MsgId), typeof(global::Google.Protobuf.Protocol.CreatureState), typeof(global::Google.Protobuf.Protocol.MoveDir), typeof(global::Google.Protobuf.Protocol.GameObjectType), }, null, new pbr::GeneratedClrTypeInfo[] {
            ...
            new pbr::GeneratedClrTypeInfo(typeof(global::Google.Protobuf.Protocol.C_ItemGet), global::Google.Protobuf.Protocol.C_ItemGet.Parser, new[]{ "Iteminfo", "PlayerObejctId" }, null, null, null, null),
  ...
  #endif
  {
    ...
    public C_ItemGet(C_ItemGet other) : this() {
      ...
      playerObejctId_ = other.playerObejctId_;
      _unknownFields = pb::UnknownFieldSet.Clone(other._unknownFields);
    }
    ...
    /// <summary>Field number for the "playerObejctId" field.</summary>
    public const int PlayerObejctIdFieldNumber = 2;
    private int playerObejctId_;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public int PlayerObejctId {
      get { return playerObejctId_; }
      set {
        playerObejctId_ = value;
      }
    }
    ...
    public bool Equals(C_ItemGet other) {
      ...
      if (PlayerObejctId != other.PlayerObejctId) return false;
      return Equals(_unknownFields, other._unknownFields);
    }
    ...
    public override int GetHashCode() {
      ...
      if (PlayerObejctId != 0) hash ^= PlayerObejctId.GetHashCode();
      if (_unknownFields != null) {
        hash ^= _unknownFields.GetHashCode();
      }
      return hash;
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (PlayerObejctId != 0) {
        output.WriteRawTag(16);
        output.WriteInt32(PlayerObejctId);
      }
      if (_unknownFields != null) {
        _unknownFields.WriteTo(output);
      }
    ...
    public int CalculateSize() {
      ...
      if (PlayerObejctId != 0) {
        size += 1 + pb::CodedOutputStream.ComputeInt32Size(PlayerObejctId);
      }
      if (_unknownFields != null) {
        size += _unknownFields.CalculateSize();
      }
    ...
    public void MergeFrom(C_ItemGet other) {
      ...
      if (other.PlayerObejctId != 0) {
        PlayerObejctId = other.PlayerObejctId;
      }
      _unknownFields = pb::UnknownFieldSet.MergeFrom(_unknownFields, other._unknownFields);
    }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      switch(tag) {
          ...
          case 16: {
            PlayerObejctId = input.ReadInt32();
            break;
          }
        }
      }
